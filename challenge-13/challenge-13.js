(function() {
    ...
    */
    var sul = ["Rio Grande do Sul", "Santa Catrina", "Paraná"];
    var sudeste = ["Minas Gerais", "Sao Paulo", "Rio de Janeiro", "Espirito Santo"];
    ...
    */
    ...
    brasil.unshift("Amazonas", "Acre", "Amapa");
    console.log(brasil);
    ...
    */
    var nordeste = ["Alagoas", "Ceara", "Maranhao", "Paraiba", "Pernambuco", "Piaui", "Rio Grande do Norte", "Sergipe"];
    ...
    */
    var newBrasil = [];
    brasil.forEach(function(item, ix) {
        newBrasil.push({id: ix, estado: item});
    });
    ...
    */
    var map = newBrasil.map(function(item, ix) {
